window.onload = function () {
  ...
  // SOCKET: Função para tratar os erros que podem ocorrer
  socket.onerror = function (error) {    
    console.log("WebSocket Error: ", error);
  };

  // SOCKET: Função chamada no momento da conexão do cliente com o servidor
  ...
  // SOCKET: Função para tratar mensagens enviadas pelo servidor.
  ...
  // SOCKET: Função chamada no momento da desconexão do servidor com o cliente
  ...
  form.onsubmit = function (e) {
    ...
    // SOCKET: Envia a mensagem através do websocket
    socket.send(message);
